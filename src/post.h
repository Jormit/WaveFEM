...
namespace post
{
	...
	structured_3d_field_data eval_full_E(const sim& sim_instance, size_t port_num, size_t num_x, size_t num_y, size_t num_z);
	structured_3d_field_data eval_full_B(const sim& sim_instance, size_t port_num, size_t num_x, size_t num_y, size_t num_z);
