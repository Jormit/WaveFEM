...
enum field_type {E_FIELD, H_FIELD};
...
namespace post
{
	...
	structured_3d_field_data eval_full(const sim& sim_instance, double wavenumber, size_t port_num, size_t num_x, size_t num_y, size_t num_z, field_type type);
	//structured_2d_field_data eval_slice(const sim& sim_instance, slice_plane slice, size_t port_num, size_t num_u, size_t num_v, double w, field_type type);
